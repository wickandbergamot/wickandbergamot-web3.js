...
# Safecoin JavaScript SDK

Use this to interact with accounts and programs on the Safecoin network through the Safecoin [JSON RPC API](https://docs.safecoin.org/apps/jsonrpc-api).
...
- For more detail on individual functions, see the [latest API Documentation](https://Fair-Exchange.github.io/safecoin-web3.js)

## Getting help

Have a question or a problem? Check the [Safecoin Stack Exchange](https://solana.stackexchange.com) to see if anyone else is having the same one. If not, [post a new question](https://solana.stackexchange.com/questions/ask).
...
- Runtimes, [by version](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/BigInt):
  ...
  - Node: >=10.4.0
- React Native:
  - \>=0.7.0 using the [Hermes](https://reactnative.dev/blog/2022/07/08/hermes-as-the-default) engine ([integration guide](https://solanacookbook.com/integrations/react-native.html#how-to-use-safecoin-web3-js-in-a-react-native-app)):
...
If you found a bug or would like to request a feature, please [file an issue](https://github.com/Fair-Exchange/safecoin-web3.js/issues/new). If, based on the discussion on an issue you would like to offer a code change, please make a [pull request](https://github.com/Fair-Exchange/safecoin-web3.js/compare). If neither of these describes what you would like to contribute, read the [getting help](#getting-help) section above.
