import { Base58EncodedAddress } from '@safecoin/keys';
...
type GetAccountInfoApiResponseBase = Readonly<{
    ...
    value: Readonly<{
        executable: boolean;
        lamports: number; // TODO(Fair-Exchange/solana/issues/30341) Represent as bigint
        owner: Base64EncodedAddress;
        rentEpoch: number; // TODO(Fair-Exchange/solana/issues/30341) Represent as bigint
        space: number; // TODO(Fair-Exchange/solana/issues/30341) Represent as bigint
    }> | null;
}>;
